...
public class ALHD extends AbstractChangeDetector {
...
//            );         
    ...
    public void resetLearning() {
    	ensemble();
    	if(changeDetectorPool.length > 1) {
    		numChangeDetectorsDecision = (int) Math.ceil((double) changeDetectorPool.length/2);
    	}else {
    ...
    @Override
    public void input(double prediction) {  //	ALHD    
